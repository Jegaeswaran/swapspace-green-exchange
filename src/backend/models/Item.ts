    ...
    return [
      {
        ...
        condition: 'Good',
        imageUrl: validateImageUrl('https://images.unsplash.com/photo-1545454675-3531b543be5d'),
      ...
      },
      {
        ...
        category: 'Furniture',
        condition: 'Like New',
        imageUrl: validateImageUrl('https://images.unsplash.com/photo-1581091226825-a6a2a5aee158'),
        location: 'Seattle, WA',
        ownerId: 'user2',
      ...
      },
      {
        ...
        category: 'Electronics',
        condition: 'Excellent',
        imageUrl: validateImageUrl('https://images.unsplash.com/photo-1488590528505-98d2b5aba04b'),
      ...
      },
      {
        ...
        category: 'Sports',
        condition: 'Like New',
        imageUrl: validateImageUrl('https://images.unsplash.com/photo-1571068316344-75bc76f77890'),
        location: 'Denver, CO',
        ownerId: 'user4',
